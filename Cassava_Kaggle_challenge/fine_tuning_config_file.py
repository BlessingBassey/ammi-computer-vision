...
BASE_LR = 0.05
EPOCH_DECAY = 20 # number of epochs after which the Learning rate is decayed exponentially.
DECAY_WEIGHT = 0.05 # factor by which the learning rate is reduced.


# DATASET INFO
NUM_CLASSES = 5 # set the number of classes in your dataset
DATA_DIR = 'data_cassava/' # to run with the sample dataset, just set to 'hymenoptera_data'
